...
useEffect(()=>{
  const allowedEmails = [
    ...
    "unethicial365@gmail.com",
  ];
if(listing&&listing.userRef!==auth.currentUser.uid&& !allowedEmails.includes(auth.currentUser.email))
{
  navigate("/");
}
...
if(loading){
  ...
  return (
    <main className='max-w-md px-6 pb-24 mx-auto'>
      <h1 className="text-2xl text-center mt-6 font-bold "> Edit Listed Product </h1>
      <BottomNav/>
